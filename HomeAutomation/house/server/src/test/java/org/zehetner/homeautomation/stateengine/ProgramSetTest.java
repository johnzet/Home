...
public class ProgramSetTest {
    ...
    public void testToXmlPeriodic() {
        ...
        sp1.setRepeat(new SprinklerRepeatPolicy(SprinklerRepeatPolicy.Type.EVERY_THREE_DAYS, null));
    ...
    public void testFromXmlPeriodic() {
        ...
        assertEquals(SprinklerRepeatPolicy.Type.EVERY_THREE_DAYS, sp1.getRepeat().getType());
