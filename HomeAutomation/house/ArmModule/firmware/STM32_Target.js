    ...
    switch ((TargetInterface.peekWord(0x40015800) & 0xfff))
      {
        case 0x417:
        case 0x447:
          return (family=="STM32L051") || (family=="STM32L052") || (family=="STM32L053") || (family=="STM32L061") || (family=="STM32L062") || (family=="STM32L063") || (family=="STM32L071") || (family=="STM32L072") || (family=="STM32L073") || (family=="STM32L083");
        case 0x440:
          return (family=="STM32F058") || (family=="STM32F051") || ((family=="STM32F030") && (density=="8"));
        case 0x442:
          return (family=="STM32F091") || (family=="STM32F098");
        case 0x444:
          return (family=="STM32F031") || (family=="STM32F038") || ((family=="STM32F030") && (density=="4" || density=="6"));
        case 0x445:
          return (family=="STM32F042") || (family=="STM32F048");
        case 0x448:
          return (family=="STM32F070") || (family=="STM32F071") || (family=="STM32F072") || (family=="STM32F078");
      }
  else
    switch ((TargetInterface.peekWord(0xE0042000) & 0xfff))
      {
        ...
        case 0x415: // STM32L4x6
          return (family == "STM32L476" || family == "STM32L486");
        case 0x416: // low and medium density STM32L
        case 0x429:
        ...
        case 0x449: // STM32F7xx
          return (family=="STM32F746" || family=="STM32F756");
        case 0x458: // STM32F410x
