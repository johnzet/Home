...
#define niBUFFER_1_PACKET_SIZE 2048
...
portBASE_TYPE xNetworkInterfaceOutput( NetworkBufferDescriptor_t * const pxBuffer, portBASE_TYPE bReleaseAfterSend )
{
...
{
static uint8_t ucNetorkPackets[ ipconfigNUM_NETWORK_BUFFER_DESCRIPTORS * niBUFFER_1_PACKET_SIZE ] __attribute__ ( ( aligned( 8 ) ) );
uint8_t *ucRAMBuffer = ucNetorkPackets;
uint32_t ul;
