 ...
 * Time: 5:42 PM
 */
public class SHT2xSensor extends JsonResponseSensor {
    private static final Logger LOG = Logger.getLogger(SHT2xSensor.class.getName());
    ...
    public SHT2xSensor(String sensorId, String sensorName, String url) {
...
//        rrdDef.addArchive(ConsolFun.MIN, 0.5, 1, (int)rows);
    ...
    public void measureAndLog() throws IOException {
        ...
        assembleDataLoggingSample(temp, hum);
    }
    ...
    public JSONArray getData() {
        ...
        try {
            ...
            FetchRequest fr = rrdDb.createFetchRequest(
                    ConsolFun.AVERAGE,
                    rrdDb.getLastUpdateTime() - (rows-1) * loopIntervalS,
                    rrdDb.getLastUpdateTime() - loopIntervalS);
    ...
    //        LOG.info(rrdDb.dump());
        ...
        try {
            while ((line = reader.readLine()) != null) {
                ...
                if (!Double.isFinite(temp) || !Double.isFinite(hum)) continue;
