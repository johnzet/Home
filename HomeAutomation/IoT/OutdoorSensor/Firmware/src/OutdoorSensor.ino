...
String topicTemperatureConfig = String("homeassistant/sensor/outdoor1/outdoor1_temperature/config");
String topicHumidityConfig =    String("homeassistant/sensor/outdoor1/outdoor1_humidity/config");
String topicPressureConfig =    String("homeassistant/sensor/outdoor1/outdoor1_pressure/config");
