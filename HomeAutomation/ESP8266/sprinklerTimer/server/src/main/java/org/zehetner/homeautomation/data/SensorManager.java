...
public class SensorManager {
    ...
    private void initSensorSet() {
        ...
        s = new BME280Sensor        ("sensor2", "Sensor 2", "http://sensor2.zhome.net/data");
        sensors.put(s.getSensorId(), s);
        s = new BME280Sensor        ("sensor3", "Sensor 3", "http://sensor3.zhome.net/data");
        sensors.put(s.getSensorId(), s);
        s = new BME280Sensor        ("sensor4", "Sensor 4", "http://sensor4.zhome.net/data");
        sensors.put(s.getSensorId(), s);
        s = new BME280Sensor        ("sensor5", "Sensor 5", "http://sensor5.zhome.net/data");
        sensors.put(s.getSensorId(), s);
