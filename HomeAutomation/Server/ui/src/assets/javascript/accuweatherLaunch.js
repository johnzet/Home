...
(function () {
    ...
    function K() {
        (function (c, b) {
            ...
            c.throttle = a = function (a, e, m, k) {
                function g() {
                    ...
                    var F = this, f = +new Date - t, u = arguments;
                    k && !v && c();
                    v && clearTimeout(v);
        ...
        (function (c) {
            c.autocomplete = function (b, a) {
                ...
                function d(b, d) {
                    ...
                    "string" == typeof a.url && 0 < a.url.length ? c.ajax({
                        type: "GET", url: I(b, d), cache: !0, dataType: "jsonp", success: function (a) {
                            a = v(a);
                            u(b, a);
                            g(b, a, d)
                        }
                ...
                function H(c) {
                    ...
                    if (a.matchSubset) for (var b = c.length - 1; b >= a.minChars; b--) {
                        var d = c.substr(0, b);
                        if (d = q.data[d]) {
                ...
                function J(b, c) {
                    ...
                    for (var d = c ? c.length : 0, h = null, k = 0; k < d; k++) {
                        ...
                        if (g[0].toLowerCase() == b.toLowerCase()) {
                            ...
                            h.selectValue = g[0];
                            var e = null;
                            if (1 < g.length) for (var e = [], u = 1; u < g.length; u++) e[e.length] = g[u];
                            h.extra = e
                        }
                    }
            ...
            c.fn.indexOf = function (b) {
                for (var a = 0; a < this.length; a++) if (this[a] ==
                    b) return a;
                return -1
            }
        })(f)
    ...
    function x(c, b) {
        ...
        window.accuweather.widgets.ThirtySixHour =
            function (a) {
                ...
                this.moveTimeBubble = function () {
                    setTimeout(function () {
                        var a = c(".aw-widget-36hour").find(".aw-time-bubble"), b = a.find("span"), d = a.find("i"),
                            g = a.find("b"), a = a.attr("data-minutes") / 60,
                            e = c(".aw-six-hours-inner ul li:first").width(), g = g.width(), a = Math.max(5, e * a),
                            a = Math.min(g - 7, a), g = a + 6;
                        b.css("left", a + "px");
                        d.css("left", g + "px")
                    }, 100)
                };
                ...
                this.el.find(".aw-search input").bind({
                    focus: function () {
                        ...
                        f.css({width: c(this).width(), top: a, left: c(this).position().left})
                    }, blur: function () {
        ...
        var m = b.data("uid") ? b.data("uid") : "aw" + (new Date).getTime(),
            a = b.data("lifestyle") ? "/" + b.data("lifestyle") : "", f = b.get(0).awType + a;
        "" != a && b.data("lifestyle");
        try {
            ...
            })(window, document, "script", "//www.google-analytics.com/analytics.js", "ga_awxoap"), ga_awxoap("create", "UA-31945348-1", "auto", {name: "awxoapTracker"}), ga_awxoap("awxoapTracker.set", "page", "/oap-weather-widgets/" + f), ga_awxoap("awxoapTracker.send", "pageview", {
