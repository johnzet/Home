...
@Component
public class SensorHostIfaceImpl implements SensorHostInterface {
    private final ZLogger log = ZLogger.getLogger(SensorHostIfaceImpl.class);

    public SensorHostIfaceImpl() {
