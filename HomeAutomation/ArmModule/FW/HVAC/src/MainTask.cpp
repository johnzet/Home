...
MainTask::MainTask(QueueHandle_t sensorSampleQ, QueueHandle_t httpRequestQueue, WiFiReceiverTask* wiFiReceiverTaskArg, 
            WiFiTransmitterTask* wiFiTransmitterTaskArg) {
...
//    uint32_t width=0;
//    uint32_t height=0;
    lcd->drawString(10, 0, "Climate Control", medFont, 0b1111, spacing);
...
//    lcd->drawRectangle(x-2,y-2, x+width+2, y+height+2, 0b0111, false);
    ...
    lcd->drawString(10, 40, "Blah blah blah Blah blah blah Blah blah blah", smallFont, 0b1111, spacing);
    lcd->drawString(10, 50, "Blah blah blah Blah blah blah Blah blah blah", smallFont, 0b1111, spacing);
    lcd->drawString(10, 60, "Blah blah blah Blah blah blah Blah blah blah", smallFont, 0b1111, spacing);
    lcd->drawString(10, 90, "Blah blah blah Blah blah blah Blah blah blah", smallFont, 0b1111, spacing);
    lcd->drawString(10, 100, "Blah blah blah Blah blah blah Blah blah blah", smallFont, 0b1111, spacing);
    lcd->drawString(10, 110, "Blah blah blah Blah blah blah Blah blah blah", smallFont, 0b1111, spacing);
