...
class WaterGateMainTask : public MainTask {
  public:
    WaterGateMainTask(QueueHandle_t sensorSampleQ, QueueHandle_t httpRequestQueue, 
...
extern "C" {
    WaterGateMainTask* irqMainTaskObject;
}
